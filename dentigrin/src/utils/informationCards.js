...
export const informationCard =[
    {
        'src' : imgService1,
        'alt' : 'Imagen de utensilios de limpieza oral',
        'title' : 'Higiene Oral',
        'description':'Nuestros servicios de higiene oral incluyen limpieza dental, pulido y tratamiento de encias. Mantenemos tu sonrisa saludable.'
    },
    {
        'src' : imgService2,
        'alt' : 'Imagen atencion en consulta odontologica',
        'title' : 'Resinas',
        'description':'Ofrecemos tratamientos de resinas para restaurar y mejorar la aparencia de tus dientes. Obten una sonrisa más brillante'
    },
    {
        'src' : imgService3,
